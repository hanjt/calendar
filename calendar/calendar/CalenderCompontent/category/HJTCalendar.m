...
@interface HJTCalendar ()

@property (nonatomic, strong) NSCalendar *gregorian;

@end

@implementation HJTCalendar
...
-(NSInteger)calendarFromDate {
    NSDateComponents *weekdayComponents = [self.gregorian components:NSCalendarUnitDay fromDate:self.date];
...
-(NSInteger)monthOfLunar{
    NSDateComponents *weekdayComponents = [self.gregorian components:NSCalendarUnitMonth fromDate:self.date];
    return [weekdayComponents month];
}

-(BOOL)isLeapMonth{
    NSDateComponents *nowComponents = [self.gregorian components:NSCalendarUnitMonth fromDate:self.date];
    
    NSDateComponents *offsetComponents = [[NSDateComponents alloc] init];
    [offsetComponents setMonth:-1];
    NSDate *monthAgo = [self.gregorian dateByAddingComponents:offsetComponents
                                                  toDate:self.date options:0];
    
    NSDateComponents *monthAgoComponents = [self.gregorian components:NSCalendarUnitMonth fromDate:monthAgo];
